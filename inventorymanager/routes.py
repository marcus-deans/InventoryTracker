...
from inventorymanager import app,db
from inventorymanager.forms import addproduct,addlocation,moveproduct,editproduct,editlocation
from inventorymanager.models import Location,Product,Movement,Balance
